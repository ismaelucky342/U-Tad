-- comandos que considero mas importantes y que he usado durante esta actividad: 
-- Crear tabla Usuario
...
mysqldump -u nombre_de_usuario -p nombre_de_la_base_de_datos > ruta/del/archivo.sql

mysqldump -u root -p yiutube > backup_yiutube.sql
