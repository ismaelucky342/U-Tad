...
for vid, _ in vehiculos:
    print(f"{vid}: {r.hgetall(f'vehiculo:{vid}')}")
...
print("\n=== CONSULTAS ===")
print("Info V001:", info_v001)
print("Campos V001 (marca, modelo, precio_dia, estado, ubicacion):", campos_v001)
print("Estado V001:", estado_v001)
print("¿Existe matrícula en V001?:", existe_v001)
...
print("\n=== ACTUALIZACIONES ===")
print("V001 tras actualización:", r.hgetall("vehiculo:V001"))
print("V003 tras actualización:", r.hgetall("vehiculo:V003"))
...
print("\n=== CONTADORES ===")
print("Total vehículos:", total)
print("Vehículos disponibles:", disponibles)
print("En uso:", r.get("stats:vehiculos:en_uso"))
print("En mantenimiento:", r.get("stats:vehiculos:mantenimiento"))
...
print("\n=== SETS POR TIPO ===")
print("Furgonetas:", furgonetas)
print("¿V001 es furgoneta?:", es_furgoneta)
print("Nº furgonetas:", num_furgonetas)
...
print("Disponibles en Madrid:", disponibles_madrid)
print("Furgonetas disponibles:", furgonetas_disponibles)
...
print("\n=== CACHÉ VEHÍCULO V001 ===")
print("Cache V001:", cache_v001)
print("TTL cache V001:", ttl_v001)
...
print("Nº campos:", num_campos)
print("V001 tras incrementos:", r.hgetall("vehiculo:V001"))
...
print("Claves:", todos_vehiculos)
for i, datos in zip(["V001", "V002", "V003"], info_basica):
    print(f"{i}: {datos}")
