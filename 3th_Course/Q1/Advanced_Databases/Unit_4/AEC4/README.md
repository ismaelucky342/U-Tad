# AEC4 - Consultas Cypher en Neo4j

## Descripción

Este proyecto consiste en una serie de consultas Cypher para trabajar con una base de datos orientada a grafos en Neo4j. La base de datos almacena información sobre películas, actores, directores, productores y guionistas, junto con las relaciones entre ellos.

## Inicialización de la base de datos

Para cargar los datos iniciales, ejecutar el script `movies_initialization.txt` en Neo4j. Este script crea los nodos de tipo Person y Movie, junto con relaciones como ACTED_IN, DIRECTED, PRODUCED y WROTE.

## Estructura del grafo

El grafo está compuesto por:

- Nodos Person: representan personas del mundo del cine (actores, directores, productores, guionistas)
- Nodos Movie: representan películas con propiedades como título, año de estreno y tagline
- Relaciones ACTED_IN: conectan actores con películas, incluyen la propiedad roles
- Relaciones DIRECTED: conectan directores con películas
- Relaciones PRODUCED: conectan productores con películas
- Relaciones WROTE: conectan guionistas con películas
- Relaciones REVIEWED: conectan personas con películas, incluyen propiedades summary y rating
- Relaciones FOLLOWS: conectan personas entre sí

## Consultas realizadas

Me he decidido al final por las siguientes 40 consultas: 
